    ...
    <>
                ...
                <div className="row">
                  <div className="col-md-6 ">
                    <div className="detail-box" style={{ marginRight: "12%" }}>
                      ...
                      <p>
                        A DApp (Decentralized Application) Employees Reward
                        ...
                        transparency, immutability, and security, to ensure efficient and fair reward distribution
                        <br /> 
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-md-4 ">
                <div className="box ">
                  ...
                  <div className="detail-box">
                    <h5>Rewards</h5>
                    <p>
                      Rewards refer to the incentives given to participants for
                      their contribution, such as validating transactions and completing tasks.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="detail-box">
                ...
                <p className="font-weight-bold text-base">
                  ...
                  transparent and efficient rewards program. With this system,
      ...
      <section className="team_section layout_padding">
        <div className="container-fluid">
          <div className="heading_container heading_center">
            <h2 className="font-weight-bold text-3xl">
            <span> Employees </span> of the Month
            </h2>
          </div>
      ...
      <section className="client_section layout_padding">
        <div className="container">
          <div className="heading_container heading_center psudo_white_primary mb_45">
            <h2 className="font-weight-bold text-3xl">
              What our <span>Employees</span> say
            </h2>
          </div>
