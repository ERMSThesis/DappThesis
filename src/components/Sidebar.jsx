...
const Sidebar = () => {
  ...
  const Menus = [
    ...
    { title: "View Rewards", path: "/viewReward", src: <FaMoneyCheckAlt /> },
    {
      title: "Manage Rewards",
      path: "/manageReward",
      src: <ManageHistoryIcon />,
    },
    { title: "Give Rewards", path: "/giveReward", src: <GiPayMoney /> },
    // {
  ...
  const UserMenu = [
    ...
    { title: "View Rewards", path: "/viewReward", src: <CardGiftcardIcon /> },
    {
      title: "View Assigned Rewards",
